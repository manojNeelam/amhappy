...
//    }
    ...
    for (int i = 0; i < buttonContainer.count; i++) {
        ...
        switch (self.direction) {
            ...
            case DirectionUp:
                originPosition = CGPointMake(self.frame.size.width/2.f+50, self.frame.size.height - self.homeButtonView.frame.size.height);
            ...
            case DirectionDown:
                originPosition = CGPointMake(self.frame.size.width/2.f+50, self.homeButtonView.frame.size.height);
                finalPosition = CGPointMake(self.frame.size.width/2.f,
...
- (void)dismissButtons {
    ...
    for (int i = (int)_buttonContainer.count - 1; i >= 0; i--) {
        ...
        switch (self.direction) {
            ...
            case DirectionUp:
                finalPosition = CGPointMake(self.frame.size.width/2.f+50, self.frame.size.height - self.homeButtonView.frame.size.height);
                break;
                
            case DirectionDown:
                finalPosition = CGPointMake(self.frame.size.width/2.f+50, self.homeButtonView.frame.size.height);
                break;
