...
//    NSData *data = [NSData dataWithContentsOfURL:url];
    ...
    [self setMinimumTrackTintColor:[UIColor orangeColor]];
...
-(RGSPreviewView *)previewViewWithFrame:(CGRect)frame color:(float )color{
    RGSPreviewView *preview = [[RGSPreviewView alloc] initWithFrame:frame];
    preview.tintColor = [UIColor orangeColor];
...
-(float )colorFromCurrentValue{

    return  self.value;//[UIColor colorWithHue: self.value
                                        //saturation: 1
                                      //  brightness: 1.0
                                        //     alpha:1.0];
}
