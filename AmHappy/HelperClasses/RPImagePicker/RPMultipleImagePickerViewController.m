...
@interface RPMultipleImagePickerViewController ()<ELCImagePickerControllerDelegate>
...
- (void) refreshTitle
{
    if(self.images.count == 1)
    {
        ...
        [self.lblNoofImages setText:[NSString stringWithFormat:@"1 %@", NSLocalizedString(@"image", @"image")]];
    ...
    }else if(self.images.count > 1)
    {
        ...
        [self.lblNoofImages setText:[NSString stringWithFormat:@"%lu %@", (unsigned long)self.images.count, NSLocalizedString(@"images", @"images")]];
    }
}
...
-(void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    if(indexPath.row == 0)
    {
        ...
        UIAlertView *alert =[[UIAlertView alloc] initWithTitle:@"" message:@"Select your image source type" delegate:self cancelButtonTitle:@"Cancel" otherButtonTitles:@"Camera",@"Photo Library", nil];
            [alert show];
...
- (void)alertView:(UIAlertView *)alertView clickedButtonAtIndex:(NSInteger)buttonIndex
{
    ...
    if(buttonIndex == 2)
    {
        ...
        elcPicker.maximumImagesCount = 5-self.images.count; //Set the maximum number of images to select to 100
...
//        [self presentViewController:_pickerController animated:YES completion:nil];
    ...
    
    {
        if (self.images.count>=5)
        {
            ...
            UIAlertView *alert =[[UIAlertView alloc] initWithTitle:@"" message:@"Maximum 5 photos Selected already!" delegate:nil cancelButtonTitle:@"Ok" otherButtonTitles:nil, nil];
            [alert show];
...
-(void)postImageNotification
{
    ...
    [userInfo setObject:self.images forKey:@"images"];
    
    NSNotificationCenter* nc = [NSNotificationCenter defaultCenter];
    [nc postNotificationName:@"commentImages" object:self userInfo:userInfo];
}
...
- (void)elcImagePickerController:(ELCImagePickerController *)picker didFinishPickingMediaWithInfo:(NSArray *)info
{
    ...
    if ([images count]>0)
    {
        ...
        {
            [self addImage:(UIImage *)[images objectAtIndex:i]];
            
        }
        
        // Done callback
        self.doneCallback = ^(NSArray *images)
        {
