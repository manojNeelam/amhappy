...
- (NSMutableDictionary *)OtherAttributes
{
    ...
    return [@{NSFontAttributeName:FONT_Regular(14.0f) ,NSForegroundColorAttributeName:[UIColor lightGrayColor]}mutableCopy];
}
...
//                                   NSFontAttributeName : FONT_Regular(14),
...
//    [mutableAttributedString addAttribute: NSFontAttributeName value:FONT_Regular(13)  range: NSMakeRange(0, mutableAttributedString.string.length)];
//    
//    [mutableAttributedString addAttribute: NSForegroundColorAttributeName value: [UIColor redColor] range: NSMakeRange(0,mutableAttributedString.string.length)];
...
- (void)setAttributes:(NSDictionary *)attributes forLinkedString:(NSString *)linkedString
{
    ...
    NSMutableAttributedString *mutableAttributedString = [[NSMutableAttributedString alloc]initWithAttributedString:[[NSAttributedString alloc]initWithString:self.text]];//self.attributedText];
...
- (void)commonInit
{
    ...
    _linkedTextDefaultFont = FONT_Regular(14);//[UIFont boldSystemFontOfSize:self.font.pointSize];
