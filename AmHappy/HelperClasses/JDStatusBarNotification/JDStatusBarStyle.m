...
+ (JDStatusBarStyle*)defaultStyleWithName:(NSString*)styleName;
{
    ...
    if ([styleName isEqualToString:JDStatusBarStyleDefault])
    {
        ...
        style.font = [UIFont fontWithName:@"PT Sans" size:15];
        //style.barColor = [UIColor colorWithRed:89/255.0 green:114/255.0 blue:186/255.0 alpha:1.0];
    ...
    // JDStatusBarStyleError
       ...
       // style.barColor = [UIColor colorWithRed:0.588 green:0.118 blue:0.000 alpha:1.000];
        style.barColor = [UIColor colorWithRed:241/255.0 green:33/255.0 blue:34/255.0 alpha:1];
        
         style.font = [UIFont fontWithName:@"PT Sans" size:16];
        
        style.textColor = [UIColor whiteColor];
        style.progressBarColor = [UIColor redColor];
       // style.progressBarColor = [UIColor colorWithRed:241/255.0 green:33/255.0 blue:34/255.0 alpha:1];
