...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        UIFont *textFont = [UIFont fontWithName:@"Helvetica Neue" size:14.0];
        CGRect textFrame =
        ...
        textFrame=_textLabel.frame;
        textFrame.origin.x=textFrame.origin.x-25;
        _textLabel.frame=textFrame;
        
        [_contentView addSubview:_textLabel];
        
        UIFont *detailFont = [UIFont fontWithName:@"Helvetica Neue" size:13.0];
        CGRect detailFrame =
